...
public class Management {
    ...
    Motorcycle m1 = new Motorcycle("Kawasaki", "Custom Plate", "Yellow", "", false);
    ...
    void hireTest1() {
        ...
        employees.add(new Manager("Cindy", 1974, 20,  80));
        employees.add(new Programmer("Paul", 1993, 10000, 75, 3));
        employees.add(new Tester("Pierre", 1987, 12000, 50,50));
        employees.add(new Programmer("Matt", 1981, 11110, 50, 5));
        employees.add(new Programmer("Sarah", 1986, 123123,3 , 5));
    ...
    void hireTest2() {
        ...
        employees.add(new Programmer("Paul", 1993, 3000, 75,1, m1));
        employees.add(new Tester("Pierre", 1987, 12312, 50,1, m2));
        employees.add(new Programmer("Matt", 1981, 5000, 110,10,  vt4));
        employees.add(new Programmer("Sarah", 1986, 1000,3, 1,  vt3));
        for (Employee employee : employees) {
            System.out.println(employee);
        }
        System.out.println("-------------------------");
